...
contract rewardRecord{
    ...
    function recordUpdate(address _userAccount,uint _value) external updateLicensed() returns(bool){
    ...
    function factoryUsedRegist(address _token, uint256 _type) external updateLicensed() returns(bool){
